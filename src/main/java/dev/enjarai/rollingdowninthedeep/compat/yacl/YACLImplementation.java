        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(getBooleanOption("general", "mod_enabled", false, false)
                                ...
                                .build())
                        .option(getBooleanOption("general", "persistent_swimming", true, false)
                                .binding(true, () -> SwimConfig.INSTANCE.persistentSwimming, value -> SwimConfig.INSTANCE.persistentSwimming = value)
                                .build())
                        .option(getBooleanOption("general", "swap_yaw_and_roll", true, false)
                                .binding(false, () -> SwimConfig.INSTANCE.swapYawAndRoll, value -> SwimConfig.INSTANCE.swapYawAndRoll = value)
                                .build())
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(getOption(Double.class, "general.strafing", "roll_strength", false, false)
                                        .controller(option -> getDoubleSlider(option, 0.1, 5, 0.1))
                                        .binding(0.2, () -> SwimConfig.INSTANCE.strafeRollStrength, value -> SwimConfig.INSTANCE.strafeRollStrength = value)
                                        .build())
